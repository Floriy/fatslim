 ...
 */
    __pyx_t_7 = __pyx_v_i;
    __pyx_t_8 = 1;
    if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_coords.shape[0];
    if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_coords.shape[1];
    ((__pyx_v_self->points[__pyx_v_i])[1]) = (*((real *) ( /* dim=1 */ ((char *) (((real *) ( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_7 * __pyx_v_coords.strides[0]) )) + __pyx_t_8)) )));
  }
 ...
 */
    ...
    __pyx_t_12 = 1;
    if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_py_self.shape[0];
    if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_py_self.shape[1];
    *((real *) ( /* dim=1 */ ((char *) (((real *) ( /* dim=0 */ (__pyx_v_py_self.data + __pyx_t_11 * __pyx_v_py_self.strides[0]) )) + __pyx_t_12)) )) = ((__pyx_v_self->points[__pyx_v_i])[1]);
  }
 ...
 */
  __pyx_t_2 = 1;
  if (__pyx_t_2 < 0) __pyx_t_2 += __pyx_v_point.shape[0];
  (__pyx_v_p[1]) = (*((real *) ( /* dim=0 */ (__pyx_v_point.data + __pyx_t_2 * __pyx_v_point.strides[0]) )));
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = __Pyx_PyBool_FromLong(__pyx_v_is_inside); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 379, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
 ...
 * 
 */
        __pyx_t_3 = ((__pyx_v_pts_c == NULL) != 0);
        if (__pyx_t_3) {
 ...
 */
          __pyx_t_7 = __pyx_v_i;
          __pyx_t_8 = 0;
          if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_pts.shape[0];
          if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_pts.shape[1];
          ((__pyx_v_pts_c[__pyx_v_i])[0]) = (*((real *) ( /* dim=1 */ ((char *) (((real *) ( /* dim=0 */ (__pyx_v_pts.data + __pyx_t_7 * __pyx_v_pts.strides[0]) )) + __pyx_t_8)) )));
 ...
 */
          __pyx_t_9 = __pyx_v_i;
          __pyx_t_10 = 1;
          if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_pts.shape[0];
          if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_pts.shape[1];
          ((__pyx_v_pts_c[__pyx_v_i])[1]) = (*((real *) ( /* dim=1 */ ((char *) (((real *) ( /* dim=0 */ (__pyx_v_pts.data + __pyx_t_9 * __pyx_v_pts.strides[0]) )) + __pyx_t_10)) )));
        }
 ...
 *     polygon_destroy(zoi)
 */
  __pyx_t_11 = __pyx_f_10fatslimlib_13core_geometry_polygon_as_array(__pyx_v_zoi); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 528, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_v_zoi_py = __pyx_t_11;
  __pyx_t_11 = 0;
